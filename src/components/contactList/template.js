import "./styles.css";
export default function getContactListTemplate() {
  return ` <!-- Aside gauche pour le formulaire -->
      <aside class="w-1/3 bg-gray-200 p-6 pb-12">
        ...
        <button
          class="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md add-contact-btn"
        >
          Add
        </button>
      </aside>
      ...
      <section class="w-2/3 p-6">
        <div class="flex justify-between items-center mb-4">
          ...
          <p class="text-gray-600 mb-4 contacts-count">
            Contacts Count :<strong> </strong> <span class="font-bold  "></span>
          </p>
        </div>
